...
const Gpcalc7 =({getinfo,calculate, getid})=>{
    ...
    return(
        <div className="bg-gradient-to-r from-[#815b5b] to-[#9e7676] pt-5 h-full flex flex-col items-center justify-center ">
            <h1 className="text-center text-[#fff8ea]  font-bold text-2xl underline tracking-wide">Gp calculator 7.00</h1>
            ...
            <form className="flex flex-col justify-center items-center pb-1 py-5" onSubmit={fill}>
                ...
                <input placeholder="Example ENG 102" value={info.tittle} onChange={add1}
                className="border-[#594545] border-2 focus:outline-0 rounded-lg px-3 text-[#594545] "/>
                ...
                <select onChange={add3} className="border-[#594545] border-2 focus:outline-0 rounded-lg px-3 text-[#594545] " >
                     <option value={false} className ="disabled:" >SELECT YOUR GRADE</option>
                    <option value="7" className="text-green-600">A</option>
                    <option value="6" className="text-green-600">B</option>
                    <option value="5" className="text-green-900">C</option>
                    <option value="4" className="text-red-900">D+</option>
                    <option value="3" className="text-red-900">D-</option>
                    <option value="2" className="text-red-700">E+</option>
                    <option value="1" className="text-red-700">E-</option>
         ...
         <div onClick={refreshpage} className="flex items-center pb-10 cursor-pointer
          justify-center text-xl tracking-wider text-[#fff8ea]"> 
